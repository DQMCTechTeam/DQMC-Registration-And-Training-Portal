...
const isRoleValid = (value) => roles.includes(value);
const isBreakOutSessionValid = (value) => breakOutSession.includes(value);
...
const Survey = () => {
  ...
  const {
    ...
    reset: resetRole,
  } = useInput(isRoleValid);

  const {
    value: breakOutSessionEntered,
    isValid: breakOutSessionIsValid,
    hasError: breakOutSessionHasError,
    valueChangeHandler: breakOutSessionChangedHandler,
    inputBlurHandler: breakOutSessionBlurHandler,
    reset: resetBreakOutSession,
  } = useInput(isBreakOutSessionValid);
  ...
  const roleClasses = roleHasError
    ? "col-md-2 col-sm-3 invalid"
    : "col-md-2 col-sm-3";

  const breakOutSessionClasses = breakOutSessionHasError
    ? "col-md-2 col-sm-3 invalid"
    : "col-md-2 col-sm-3";
  return (
    <Fragment>
      ...
      <div class="row">
        ...
        <div className={breakOutSessionClasses}>
          <select
            onChange={breakOutSessionChangedHandler}
            onBlur={breakOutSessionBlurHandler}
            name="Session"
            id="Session"
            value={breakOutSessionEntered}
          >
